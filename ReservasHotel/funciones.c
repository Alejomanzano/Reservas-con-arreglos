...
// Función para leer archivo de clientes
...
// Función para escribir archivo de clientes
void escribirClientes(char clientes[][2][40]) {
...
// Función para leer archivo de habitaciones
void leerHabitaciones(char habitaciones[][3][40], double precios[]) {
    FILE *file = fopen("habitaciones.txt", "r");
    if (file == NULL) {
        printf("Error al abrir archivo de habitaciones\n");
        return;
    }
    for (int i = 0; i < 9; i++) {
...
// Función para escribir archivo de habitaciones
void escribirHabitaciones(char habitaciones[][3][40], double precios[]) {
    FILE *file = fopen("habitaciones.txt", "w");
    if (file == NULL) {
        printf("Error al abrir archivo de habitaciones\n");
        return;
    }
...
// Función para leer archivo de reservas
void leerReservas(int reservas[][4]) {
    FILE *file = fopen("reservas.txt", "r");
    if (file == NULL) {
        printf("Error al abrir archivo de reservas\n");
        return;
    }
    for (int i = 0; i < 10; i++) {
...
// Función para escribir archivo de reservas
void escribirReservas(int reservas[][4]) {
